...
import { LoginService, RoleType } from './login.service';

@Injectable()
export class RestrictedAuthGuard implements CanActivate, CanLoad {
    ...
    checkLoggedIn(url: string): boolean {
        if(this.loginService.isLoggedIn() && this.loginService.getUserRoleType() === RoleType.Sysadmin){
            return true;
        }
