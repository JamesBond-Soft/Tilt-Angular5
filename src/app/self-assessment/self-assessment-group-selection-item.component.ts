...
@Component({
  selector: 'self-assessment-group-selection-item',
  // template: `
  ...
  //   </ul>
  // </li>`,
  templateUrl: './self-assessment-group-selection-item.component.html',
...
export class SelfAssessmentGroupSelectionItemComponent implements OnDestroy {
