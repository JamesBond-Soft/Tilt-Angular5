...
// Native Javascript for Tilt 4.0
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.pg.Notification = pg.Notification;
        root.pg.Select = pg.Select;

        root.Velocity = root.Velocity || $.Velocity;
    }
}(this, function () {

    /* Native Javascript for Tilt 4.0 | Internal Utility Functions
     ----------------------------------------------------------------*/
    "use strict";
    ...
    var Tilt = function(){
         ...
         * @returns {string} - Appends OSName to Tilt.$body
         */
         ...
         * @returns {string} - Appends Device to Tilt.$body
         */
         ...
         * @param {string} color - tilt color class eg: primary,master,master-light etc.
         * @param {int} opacity
         * @returns {rgba}
         */
    ...
    Card.prototype = {
        ...
        maximize:function() {
            ...
            if (pg.hasClass(this.element,'card-maximized')) {
                ...
                var sidebar = document.querySelector('[data-tilt="sidebar"]');
        ...
        refresh:function(refresh) {
            ...
            if (refresh) {
                ...
                if (this.options.progress == 'circle') {
                    ...
                    var iconNew;
                    if (!toggle.querySelector('[class$="-animated"]').length) {
        ...
        error:function(error) {
            if (error) {
                ...
                new pg.Notification(this.element, {
                    style: 'bar',
                    message: error,
                    position: 'top',
                    timeout: 0,
                    type: 'danger',
                    onShown: function() {
                        var elem = _this.loader.querySelector(':scope > div')
...
//Search.VERSION = "1.0.0";
    ...
    Search.prototype = {
        init:function() {
            ...
            pg.on(this.element,'click', function(e) {
                if(e.target.getAttribute('data-tilt') === 'search'){
                    _this.toggleOverlay('hide');
                }
            });
    ...
    Select.prototype._createSelectEl = function() {
        ...
        this.el.insertAdjacentElement('afterend', wrapper);
     ...
     */
    Select.prototype._changeOption = function() {
...
// ALERT DEFINITION
    // ================
    var SideBar = function( element1, options ) {
        var element = null;

        // initialization element
        element = pg.queryElement(element1);
        ...
        var self = this,
            ...
            closeSideBar = function(e) {
                ...
                if (pg.hasClass(element.querySelector('.sidebar-overlay-slide'),'show')) {
                    ...
                    // $("[data-tilt-toggle']").removeClass('active')
                }
        ...
        if ( !(this.stringSideBar in element ) ) { // prevent adding event handlers twice
            ...
            pg.live('.sidebar-menu a','click',function(e){
                ...
                if(pg.hasClass(li,"open")){
                    ...
                    if(openMenu){
                        var openSub = openMenu.querySelector("ul");
        ...
        pg.live('.sidebar-slide-toggle','click', function(e) {
            e.preventDefault();
            pg.toggleClass(this,'active');
            var el = this.getAttribute('data-tilt-toggle');
            if (el != null) {
                //Only by ID
